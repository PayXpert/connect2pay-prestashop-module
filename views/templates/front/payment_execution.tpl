    ...
    <form action="{$this_link|escape:'html'}" method="post">
       ...
       {else}
          ...
          <p class="cheque-indent">
           <strong class="dark">
        {/if}
            <img src="{$this_path|escape:'htmlall':'UTF-8'}views/img/payment-types/creditcard.png" alt="{l s='Credit Card' mod='payxpert'}" style="float:left; margin: 0px 10px 5px 0px;" />
