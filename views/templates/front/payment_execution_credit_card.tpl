    ...
    {else}
      <div class="row">
        ...
        <div class="col-xs-12 col-md-2">
          <img src="{$this_path|escape:'htmlall':'UTF-8'}views/img/payment-types/{$payment_logo|escape:'htmlall':'UTF-8'}.png" alt="{l s='Credit Card' mod='payxpert'}">
        </div>
        <div class="col-xs-12 col-md-10">
          <strong class="dark">
            {l s='You have chosen to pay by Credit Card.' mod='payxpert'}<br>
          </strong>
          <p>
