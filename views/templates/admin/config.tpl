...
<form method="post">
    <fieldset>
        ...
        <div class="margin-form">
            <input type="text" id="PAYXPERT_ORIGINATOR" size="64" name="PAYXPERT_ORIGINATOR" value="{$PAYXPERT_ORIGINATOR|escape:'htmlall':'UTF-8'}" />
        ...
        <div class="margin-form">
            <input type="text" id="PAYXPERT_URL" size="64" name="PAYXPERT_URL" value="{$PAYXPERT_URL|escape:'htmlall':'UTF-8'}" />
        ...
        <div class="margin-form">
            <input type="text" id="PAYXPERT_MERCHANT_NOTIF_TO" size="64" name="PAYXPERT_MERCHANT_NOTIF_TO" value="{$PAYXPERT_MERCHANT_NOTIF_TO|escape:'htmlall':'UTF-8'}" />
